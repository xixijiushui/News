...
extension SmallVideoViewController {
    ...
    func setupUI() {
        ...
        collectionView.zw_registerCell(cell: SmallVideoCell.self)
...
extension SmallVideoViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.zw_dequeueReusableCell(indexPath: indexPath) as SmallVideoCell
