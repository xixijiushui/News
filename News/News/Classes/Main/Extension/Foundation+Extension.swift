...
extension TimeInterval {
    ...
    func convertString() -> String {
        ...
        // 获取日期的年份
        let comps = calendar.dateComponents([.year, .month, .day, .hour, .minute, .second], from: createDate, to: Date())
        // 日期格式
...
extension Date {
    ...
    func isThisYear() -> Bool {
        ...
        let calendar = Calendar.current
        // 获取日期的年份
        let yearComps = calendar.component(.year, from: self)
        // 获取现在的年份
        let nowComps = calendar.component(.year, from: self)
    ...
    func isBeforeYesterday() -> Bool {
        ...
        let calendar = Calendar.current
        // 获取日期的年份
        let comps = calendar.dateComponents([.year, .month, .day], from: self, to: Date())
    ...
    func isYesterday() -> Bool {
        ...
        // 获取日期的年份
        let comps = calendar.dateComponents([.year, .month, .day], from: self, to: Date())
        // 头条数据返回有问题,一般来说comps.day == 0应该是x同一天
