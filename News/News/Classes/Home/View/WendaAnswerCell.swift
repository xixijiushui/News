...
class WendaAnswerCell: UITableViewCell, RegisterCellOrNib {
    ...
    var answer = WendaAnswer() {
        didSet {
            ...
            contentLabel.setSeparatedLinesForm(answer.attributedString!, hasImage: answer.content_abstract.hasImage!)
